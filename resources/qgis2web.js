...
map.getView().fit([354383.787606, 8696605.840535, 1246155.876452, 9249014.343773], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UNIDADES GEOLOGICAS DEL DEPARTAMENTO DE UCAYALI</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (14 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@ YOEL SALAZAR';
            }
